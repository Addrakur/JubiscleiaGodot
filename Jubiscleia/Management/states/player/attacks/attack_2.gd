...
func enter_state() -> void:
	...
	animation.play(PlayerVariables.current_skill + "_2",-1,PlayerVariables.attack_speed,false)
	PlayerVariables.current_attack = PlayerVariables.current_skill + "_2"
	...
	player.attack_area.damage = PlayerVariables.get(str(PlayerVariables.current_skill) + "_2_damage") * PlayerVariables.damage_mult
	player.attack_area.knockback_force = PlayerVariables.get(str(PlayerVariables.current_skill) + "_2_knockback")
	player.attack_area.knockup_force = PlayerVariables.get(str(PlayerVariables.current_skill) + "_2_knockup")
	player.attack_area.poise_damage = PlayerVariables.get(str(PlayerVariables.current_skill) + "_2_poise")
