...
func enter_state() -> void:
	...
	PlayerVariables.current_attack = PlayerVariables.get("skill_" + PlayerVariables.current_skill + "_weapon") + "_" + PlayerVariables.get("skill_" + PlayerVariables.current_skill + "_element") + "_attack_" + str(PlayerVariables.get("skill_" + PlayerVariables.current_skill + "_attack_2"))
